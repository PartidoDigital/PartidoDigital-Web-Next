...
#    typescript>tsc => path of typescript compiler,
#    typescript>js_dest => output of js files after compilation
...
module Jekyll
	class TsGenerator < Generator
		...
		def generate(site)
			...
			tsc = site.config['typescript']["tsc"] || "tsc"

			# js destination
			js_dest = site.config['typescript']["js_dest"] || "/"
